  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved adventure as @adventure" do
        ...
        post :create, {:adventure => { "title" => "invalid value" }}, valid_session
        assigns(:adventure).should be_a_new(Adventure)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested adventure" do
        ...
        Adventure.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => adventure.to_param, :adventure => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the adventure as @adventure" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Adventure.any_instance.stub(:save).and_return(false)
        put :update, {:id => adventure.to_param, :adventure => { "title" => "invalid value" }}, valid_session
        assigns(:adventure).should eq(adventure)
      end
