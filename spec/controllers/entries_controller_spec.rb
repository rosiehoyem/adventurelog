  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved entry as @entry" do
        ...
        post :create, {:entry => { "event" => "invalid value" }}, valid_session
        assigns(:entry).should be_a_new(Entry)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested entry" do
        ...
        Entry.any_instance.should_receive(:update).with({ "event" => "MyString" })
        put :update, {:id => entry.to_param, :entry => { "event" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the entry as @entry" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Entry.any_instance.stub(:save).and_return(false)
        put :update, {:id => entry.to_param, :entry => { "event" => "invalid value" }}, valid_session
        assigns(:entry).should eq(entry)
      end
